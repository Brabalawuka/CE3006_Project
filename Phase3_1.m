...
%sampling time
time = 1/(2 * Fs): 1/Fs: encodedNumberOfBits/dataRate;
...
sampled_input = kron(encoded_input, extension_vector);
...
for runs = 1:20
    ...
    for SNR = 0:5:50
        ...
        noise = noise_std .* randn(1, encodedNumberOfBits * Fs/dataRate);
        ...
        decoded_signal = zeros(1,encodedNumberOfBits);
        for i = 1:1:encodedNumberOfBits
